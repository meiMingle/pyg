...
public class GoodsController {
    ...
    @RequestMapping("/goodsAudit/{selectIds}/{auditStatus}")
    public Result goodsAudit(@PathVariable("selectIds") Long[] selectIds, @PathVariable("auditStatus") String auditStatus) {


        try {
            goodsService.goodsAudit(selectIds, auditStatus);
